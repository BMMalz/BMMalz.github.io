<?php
 ...
 class User{
    ...
    $Image0->Tags = array("clouds", "mountains", "snow", "trees");
    $Image0->Description = "Bavarian Alps in Garmisch, Bavaria, Germany (2010).";
    ...
    $Image1->Tags = array("people", "buildings", "town");
    $Image1->Description = "The Old Town Hall, Bonn, Germany (2012).";
    ...
    $Image2->Tags = array("people", "buildings", "trees", "grass");
    $Image2->Description = "The university in Bonn, Germany (2012).";
    ...
    $Image3->Tags = array("water", "buildings", "trees");
    $Image3->Description = "View from Dartmouth, Devon, UK (2008).";
    ...
    $Image4->Tags = array("sky", "trees", "water", "rainbow");
    $Image4->Description = "Rainbow over Dartmouth, Devon, UK (2008).";
    ...
    $Image5->Tags = array("buildings", "sky", "street", "city");
    $Image5->Description = "Typical street in Dartmouth, Devon, UK (2008).";
    ...
    $Image6->Tags = array("people", "sky", "steet", "town", "buildings");
    $Image6->Description = "Downtown Hof, Northern Bavaria, Germany (2012). This is the home of my mother's side of the family.";
    ...
    $Image7->Tags = array("buildings", "sky");
    $Image7->Description = "Roof of Gaudi's House of Bones, Barcelona, Spain (2007).";
    ...
    $Image8->Tags = array("people", "street");
    $Image8->Description = "Children at the festival in Wallgau, Bavaria, Germany (2010).";
    ...
    $Image9->Tags = array("people", "sky", "buildings");
    $Image9->Description = "The Magic Fountain in Barcelona, Spain (2007).";
    
    $Image10 = new Image();
    $Image10->Name = "neuschwanstein";
    ...
    $Image10->Tags = array("sky", "trees", "buildings");
    $Image10->Description = "Neuschwanstein Castle, Bacaria, Germany (2010).";
    ...
    $Image11->Tags = array("trees", "water", "sky");
    $Image11->Description = "Covered bridge in Lincoln, NH (2007).";
    ...
    $Image12->Tags = array("trees", "sky", "mountains");
    $Image12->Description = "Mts. Lincoln and Flume, Lincoln, NH (2007).";
    ...
    $Image13->Tags = array("water", "sky");
    $Image13->Description = "The site of the castle of the mythical King Arthur in Tintagel, Cornwall, UK (2008).";
    ...
    $Image14->Tags = array("people", "buildings", "town");
    $Image14->Description = "Festival in Wallgau, Bavaria, Germany (2010).";
    ...
    $Image15->Tags = array("buildings", "trees", "grass");
    $Image15->Description = "Arundel Castle in West Sussex, UK, still inhabited by the Duke of Norfolk (2005).";
    ...
    $Image16->Tags = array("buildings", "trees", "water");
    $Image16->Description = "The moated Bodiam Castle in East Sussex, UK (2005).";
    ...
    $Image17->Tags = array("grass", "buildings", "people");
    $Image17->Description = "A view of Eastbourne, on the coast in East Sussex, UK (2005).";
    ...
    $Image18->Tags = array("buildings", "trees", "grass", "sky");
    $Image18->Description = "Hever Castle in Kent, UK, childhood home of Anne Boleyn (2005).";
    ...
    $Image19->Tags = array("trees", "grass", "buildings");
    $Image19->Description = "A view of Kingston near Lewes, UK (2005).";
    ...
    $Image20->Tags = array("buildings", "water", "sky");
    $Image20->Description = "Leeds Castle in Kent, UK, Henry VIII's favorite residence (2005).";
    ...
    $Image21->Tags = array("grass", "buildings", "town");
    $Image21->Description = "Looking at the town from the top of Lewes Castle, Lewes UK (2005).";
    ...
    $Image22->Tags = array("animals", "grass", "sky");
    $Image22->Description = "Got sheep?";
    ...
    $Image23->Tags = array("grass", "trees", "sky");
    $Image23->Description = "A view of the South Downs at sunset. The town of Lewes, UK, is in the distance (2005).";
    ...
    $Image24->Tags = array("grass", "people", "trees");
    $Image24->Description = "Southover Grange Gardens, Lewes, UK (2005).";
    ...
    $Image25->Tags = array("trees", "buildings");
    $Image25->Description = "St. Pancras church (13th c.) in Kingston near Lewes, UK (2005).";
    ...
    $Image26->Tags = array("trees", "mountains");
    $Image26->Description = "Baldy Mountain from Copper Park, Philmont Scout Ranch, NM (2017).";
    ...
    $Image27->Tags = array("mountains", "trees");
    $Image27->Description = "Baldy Mountain from meadow south of Miranda, Philmont Scout Ranch, NM (2017).";
    ...
    $Image28->Tags = array("mountains", "sky");
    $Image28->Description = "Evening in the canyon, Philmont Scout Ranch, NM (2017).";
    ...
    $Image29->Tags = array("people", "grass", "sky");
    $Image29->Description = "Low clouds heading to Rich Cabin, Philmont Scout Ranch, NM (2017).";
    ...
    $Image30->Tags = array("people", "sky");
    $Image30->Description = "Climbing a spar pole, Philmont Scout Rance, NM (2017).";
    ...
    $Image31->Tags = array("people", "trees", "grass");
    $Image31->Description = "Hiking the canyon, Philmont Scout Ranch, NM (2017).";
    ...
    $Image32->Tags = array("mountains", "trees");
    $Image32->Description = "The Tooth of Time, Philmont Scout Ranch, NM (2017).";
    ...
    $Image33->Tags = array("grass");
    $Image33->Description = "Where are we going? Philmont Scout Ranch, NM (2017).";
    ...
    $Image34->Tags = array("trees", "mountains");
    $Image34->Description = "Looking up the canyon to the north, Philmont Scout Ranch, NM (2017).";
    ...
    $Image35->Tags = array("people", "water");
    $Image35->Description = "Jumping off the \"Jaws Bridge,\" Martha's Vineyard, MA (2015).";
    ...
    $Image36->Tags = array("people", "buildings", "town");
    $Image36->Description = "MVCMA cottages, Oak Bluffs, Martha's Vineyard, MA (2015).";
    ...
    $Image37->Tags = array("water", "sky");
    $Image37->Description = "Paines Creek, Brewster, Cape Cod, MA (2016).";
    ...
    $Image38->Tags = array("water", "boat");
    $Image38->Description = "Boy Scout Sea Base, Islamorada, Florida Keys (2015).";
    ...
    $Image39->Tags = array("water", "boat");
    $Image39->Description = "Sail boats, Islamorada, Florida Keys (2015).";
    ...
    $Image40->Tags = array("water", "boat");
    $Image40->Description = "At the dock at Sea Base, Islamorada, Florida Keys (2015).";
    ...
    $Image41->Tags = array("water", "boat");
    $Image41->Description = "Under sail, Florida Keys (2015).";
    ...
    $Image42->Tags = array("water", "boat");
    $Image42->Description = "Evening sets in, somewhere in the Gulf of Mexico off the Florida Keys (2015.)";
    ...
    $Image43->Tags = array("boat", "water");
    $Image43->Description = "Vineyard Haven harbor, Martha's Vineyard, MA (2015).";
    ...
    $Image44->Tags = array("building", "sky", "lighthouse");
    $Image44->Description = "West Chop lighthouse, Martha's Vineyard, MA (2015).";
    
    $Image45 = new Image();
    $Image45->Name = "westChop2";
    $Image45->Continent = "North America";
    $Image45->Country = "USA";
    $Image45->Date = "2015";
    $Image45->Location = "Massachusetts";
    $Image45->filename = "images/Joe/CapeCod/westChop2.jpg";
    $Image45->Tags = array("water", "sky");
    $Image45->Description = "West Chop, Martha's Vineyard, MA (2015).";
    ...
    $Image46->Tags = array("animal", "grass");
    $Image46->Description = "Bison in the way, Yellowstone National Park, WY (2016).";
    ...
    $Image47->Tags = array("water", "animal", "trees");
    $Image47->Description = "Mud pot, Yellowstone National Park, WY (2016).";
    ...
    $Image48->Tags = array("water", "mountains", "trees");
    $Image48->Description = "Castle Geyser, Yellowstone National Park, WY (2016).";
    ...
    $Image49->filename = "images/Joe/Yellowstone/grandCanyon4.jpg";
    $Image49->Tags = array("water", "mountains", "trees");
    $Image49->Description = "Lower Falls in the Grand Canyon of the Yellowstone, Yellowstone National Park, WY (2016).";
    ...
    $Image50->Tags = array("water", "mountains", "trees");
    $Image50->Description = "Lower Falls, Yellowstone National Park, WY (2016).";
    ...
    $Image51->Tags = array("water", "mountains");
    $Image51->Description = "Grand Prismatic Spring, Yellowstone National Park, WY (2016)";
    ...
    $Image52->Tags = array("trees", "mountains");
    $Image52->Description = "Looking towards Lake Yellowstone from the top of Mt. Washburn (10,243 ft.), Yellowstone National Park, WY (2016).";
    ...
    $Image53->Tags = array("water", "trees");
    $Image53->Description = "Yellowstone Lake, Yellowstone National Park, WY (2016).";
